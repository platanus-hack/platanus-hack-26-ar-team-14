	...
	function applyWeekSuggestion(weekId: string) {
		startTransition(() => {
			...
			appendTeacherMessage(
				"Aplicar sugerencia de replanificación en esta semana.",
			);
				...
				>
					...
					>
						...
						<p className="mt-3 text-sm leading-6 text-slate-600">
							Esta carga es mockeada para la demo. Al confirmar, el copiloto
							asume que recibió el archivo y actualiza la recomendación del
							plan.
						</p>
						<div className="mt-6 flex gap-3">
							<button
								...
								onClick={() => {
									appendTeacherMessage(
										`${modalAction}: archivo listo para revisar.`,
									);
									appendAssistantReply(
