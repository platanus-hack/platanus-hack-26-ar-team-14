...
class Material(Base):
    """Material vinculado a un PlanAnualItem (guía, recurso, etc.).

    `kind` discrimina el tipo; cuando es "guia", `guia_id` apunta a la
    guía existente y la UI puede enlazar al editor correspondiente.
    Las pruebas y sus resultados viven en el modelo `Assessment`.
    """
